...
# curl -s -m 20 http://54.251.169.42/v1/embeddings -H "Authorization: Bearer gr_sk_ca6b414016e93956ec437c0a3c37fe4b5a24ef43a7b04cf2" -H 'Content-Type: application/json' -d '{"model":"qwen3-embedding-4b","input":"hello world"}'
