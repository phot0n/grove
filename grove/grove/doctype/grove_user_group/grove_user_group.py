...
from grove.grove.doctype.grove_user.grove_user import mark_users_dirty
...
class GroveUserGroup(Document):
	...
	points at it, so an edit here is one push however many members the group has."""
	...
	def on_trash(self):
		# The members have to stop naming a group that no longer exists — otherwise they keep
		...
		mark_users_dirty(self.member_users)
